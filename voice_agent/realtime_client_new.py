...
class RealtimeClient:
    def __init__(self, instructions, voice="ash"):
        ...
        self.VAD_config = {
            ...
            "silence_duration_ms": 800  # Increased from 600 to 800ms - requires longer silence to stop
        }
    ...
    async def handle_event(self, event):
        ...
        # ── Agent Output Text Events ──
            ...
            if agent_text:
                logger.info(f"🤖 AGENT TEXT OUTPUT: '{agent_text}'")
        ...
        # ── Agent Audio Events ──
            ...
            if self.audio_buffer:
                logger.info(f"🔊 AGENT AUDIO OUTPUT: {len(self.audio_buffer)} bytes of audio data")
